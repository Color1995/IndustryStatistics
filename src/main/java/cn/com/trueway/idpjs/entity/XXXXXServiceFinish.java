...
public class XXXXXServiceFinish implements Serializable{

	private static final long serialVersionUID = 2211648712869951202L;
	...
	public String toString() {
		return "Fwyjgxm [id=" + id + ", projectCode=" + projectCode + ", projectName=" + projectName
				...
				+ ", taxRegCode=" + taxRegCode + ", checkZhdc=" + checkZhdc + ", reserved1=" + reserved1
				+ ", checkResult=" + checkResult + ", devicePrice=" + devicePrice + ", RESERVED2=" + RESERVED2
				+ ", YEAR=" + YEAR + ", belongArea=" + belongArea + "]";
	}
