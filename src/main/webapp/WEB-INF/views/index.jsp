...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/statics/layuimini/lib/layui-v2.5.4/css/layui.css" media="all">
    <link rel="stylesheet" href="${ctx}/statics/layuimini/css/layuimini.css" media="all">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${ctx}/page/user-setting.html" data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
    ...
    //    layuimini.init('${ctx}/statics/layuimini/api/init.json');
        ...
        $('.login-out').on("click", function () {
            layer.msg('退出登录成功', function () {
                window.location = '${ctx}/system-index.html';
            });
        });
    });
